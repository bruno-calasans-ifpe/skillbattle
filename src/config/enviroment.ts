...
export const FIREBASE_MESSEGER_SENDER_ID =
  process.env.NEXT_PUBLIC_MESSAGING_SENDER_ID;
export const FIREBASE_APP_ID = process.env.NEXT_PUBLIC_APP_ID;

export const GOOGLE_SECRET_ID = process.env.NEXT_PUBLIC_GOOGLE_SECRET_ID;
